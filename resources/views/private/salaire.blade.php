...
<section class="colCenterContainer space-y-12 mt-4 px-6 mb-32 bgPage">
    ...
    <div class="colCenterContainer">
        ...
        <div class="rowCenterContainer">
            <span class="normalText text-center">Indice de gestion d'argent : <span class="normalTextBleuLogo font-bold">{{ number_format($salaires->sum('montant_transaction') / ($depenses->sum('montant_transaction') + $abonnementsHistories->sum('montant_transaction')), 2, ',', ' ') }}</span></span>
