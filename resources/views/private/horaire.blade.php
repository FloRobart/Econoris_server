...
@section('content')
<!-- Titre de la page -->
@include('components.page-title', ['title' => 'Horaires'])
        ...
        <form id="form" action="{{ route('horaire.add') }}" method="POST" class="rowStartContainer hidden">
            ...
            <div class="colCenterContainer">
                <div class="colStartContainer lg:rowStartContainer">
                    ...
                    <input id="heure_matin"      name="heure_matin"      required type="time" placeholder="Heure de début" min="00:00" max="23:59"  value="09:00" title="Renseigner l'heure de début du travail" class="w-[55%] mx-2 min-[500px]:mx-4 my-2 text-center inputForm smallText">
