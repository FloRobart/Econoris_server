...
<section class="colCenterContainer space-y-12 mt-4 px-6 mb-32 bgPage">
    ...
    <div class="colCenterContainer">
        ...
        <div class="rowCenterContainer">
            <span class="normalText text-center">Nombre d'investissement : <span class="normalTextBleuLogo font-bold">{{ $investissements->count() }}</span></span>
        </div>

        <!-- Montant total investie -->
        <div class="rowCenterContainer">
            <span class="normalText text-center">Montant total investie : <span class="normalTextBleuLogo font-bold">{{ number_format($investissements->sum('montant_transaction'), 2, ',', ' ') }} €</span></span>
        </div>

        <!-- Montant total des frais -->
        <div class="rowCenterContainer">
            <span class="normalText text-center">Montant total des frais de transaction : <span class="normalTextBleuLogo font-bold">{{ number_format($investissements->sum('frais_transaction'), 2, ',', ' ') }} €</span></span>
        </div>
            ...
            <form id="form" action="{{ route('investissement.add') }}" method="POST" class="rowStartContainer hidden">
                ...
                <div class="colCenterContainer">
                    <div class="colStartContainer md:rowStartContainer">
                        ...
                        <input id="quantite"            name="quantite"            required type="number" step="0.01" placeholder="Quantité" min="0"          class="w-[55%] mx-2 min-[500px]:mx-4 my-2 text-center inputForm smallText">
                    </div>
...
<script>
    ...
    function editInvestissement(date, nom_actif, montant, frais, quantite, id) {
